...
public class MiaoshaGoodsServiceImpl implements MiaoshaGoodsService {
    ...
    @Override
    @Cacheable(cacheNames = "redisCache", key = "'miaosha_goods_info_list'")
    public List<MiaoshaGoodsVo> selectMiaoshaGoodsInfo() {
        return miaoshaGoodsMapper.selectMiaoshaGoodsInfo();
    }

    @Override
    @Cacheable(cacheNames = "redisCache", key = "'miaosha_goods_info_'+#id")
    ...
    @Override
    public List<MiaoshaGoods> selectAll() {
        return miaoshaGoodsMapper.selectAll();
    }
}
